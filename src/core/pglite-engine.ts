...
export class PGLiteEngine implements BrainEngine {
  ...
  async getHealth(): Promise<BrainHealth> {
    ...
    // Mirrors postgres-engine.ts: surface split + trusted-graph coverage are
    // computed outside the health CTE so both engines share one definition of
    // "real knowledge page". brain_score deliberately does not consume them.
